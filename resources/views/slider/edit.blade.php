@extends('back.layout.layout', [$title = 'Edit slider'])
...
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Edit slider</h4>
            ...
            <div class="form-body">
              ...
              <fieldset class="form-group">
                <div class="image-preview" >
                    <img style="max-width: 120px;" src="{{ asset($slider->image) }}" alt="image">
                </div>
