@extends('back.layout.layout', [$title = 'All blogs'])
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-content collapse show">
            <div class="card-body appointment-table card-dashboard table-responsive">
                {{$dataTable->table()}}
            </div>
          </div>
        </div>
...
@push('db_js')
    ...
    <script>
         ...
         $('.dataTable').on('click', '.delete-data', function(e) {
             e.preventDefault();
             let deleteRoute = "{{ route('appointment.delete') }}";
