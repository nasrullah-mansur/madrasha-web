...
<div class="col-12">
    <div class="card">
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <form class="form" action="{{ route('blog.category.update', $category->id) }}" method="POST">
            @csrf
            <div class="form-body">
              ...
              <fieldset class="form-group">
                ...
                <textarea id="seo_meta" rows="5" class="form-control" name="seo_meta" placeholder="SEO Meta">{{ $category->seo_meta }}</textarea>
              ...
              <fieldset class="form-group">
                ...
                <textarea id="head_script" rows="5" class="form-control" name="head_script" placeholder="Head Script">{{ $category->head_script }}</textarea>
              ...
              <fieldset class="form-group">
                ...
                <textarea id="body_script" rows="5" class="form-control" name="body_script" placeholder="Body Script">{{ $category->body_script }}</textarea>
