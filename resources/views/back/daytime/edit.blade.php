@extends('back.layout.layout', [$title = 'Edit Day and Time'])

@section('content')
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Edit Day & Time</h4>
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <form class="form" action="{{ route('day.time.update', $daytime->id) }}" method="POST">
            @csrf
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <input value="{{ $daytime->day }}" type="text" id="day" class="form-control square {{ $errors->has('day') ? 'is-invalid' : ''}}" placeholder="Day" name="day">
                @if ($errors->has('day'))
              ...
              <div class="form-group">
                ...
                <input value="{{ $daytime->time }}" type="text" id="time" class="form-control square {{ $errors->has('time') ? 'is-invalid' : ''}}" placeholder="Time" name="time">
                @if ($errors->has('time'))
