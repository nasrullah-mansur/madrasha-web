@extends('back.layout.layout', [$title = 'Create a new video']);
...
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Create a new video</h4>
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <form class="form" action="{{ route('video_gallery.store') }}" method="POST" >
            @csrf
            <div class="form-body">
              
              <fieldset class="form-group">
                <label for="iframe_link">Iframe Link</label>
                <textarea id="iframe_link" rows="5" class="form-control" name="iframe_link" placeholder="iframe_link"></textarea>
