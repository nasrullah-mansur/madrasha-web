@extends('back.layout.layout', [$title = 'Edit notice'])
...
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Edit notice</h4>
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <form class="form" action="{{ route('notice.update') }}" method="POST" >
            @csrf
            <div class="form-body">
