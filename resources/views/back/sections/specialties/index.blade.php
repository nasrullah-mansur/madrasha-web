@extends('back.layout.layout', [$title = 'All Specialties', $add_btn = 'Add Specialties', $add_btn_link = route('specialties.create')])
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex action-btn">
                          <a class="btn btn-icon btn-success" style="margin-right: 5px;" href="{{ route('specialties.edit', $special->id) }}"><i class="ft-edit"></i></a>
...
@push('db_js')  
    <script>
         ...
         $('.table').on('click', '.delete-data', function(e) {
             e.preventDefault();
             let deleteRoute = "{{ route('specialties.delete') }}";
