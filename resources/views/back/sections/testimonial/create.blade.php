@extends('back.layout.layout', [$title = 'Create Testimonial'])

@section('content')
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Create Testimonial</h4>
          ...
          <form class="form" action="{{ route('testimonial.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="subsubtitle" class="form-control square {{ $errors->has('subtitle') ? 'is-invalid' : ''}} " placeholder="Sub Title" name="subtitle">
              ...
              <div class="form-group">
                ...
                <input type="text" id="btn_text" class="form-control square {{ $errors->has('btn_text') ? 'is-invalid' : ''}} " placeholder="Button Text" name="btn_text">
              ...
              <div class="form-group">
                ...
                <input type="text" id="btn_link" class="form-control square {{ $errors->has('btn_link') ? 'is-invalid' : ''}} " placeholder="Button Link" name="btn_link">
