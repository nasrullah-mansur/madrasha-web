@extends('back.layout.layout', [$title = 'All Testimonial', $add_btn = 'Add Testimonial', $add_btn_link = route('testimonial.create')])
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex action-btn">
                          <a class="btn btn-icon btn-success" style="margin-right: 5px;" href="{{ route('testimonial.edit', $special->id) }}"><i class="ft-edit"></i></a>
...
@push('db_js')  
    <script>
         ...
         $('.table').on('click', '.delete-data', function(e) {
             e.preventDefault();
             let deleteRoute = "{{ route('testimonial.delete') }}";
